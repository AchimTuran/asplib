...
COPY /A %ASPLIB_MATLABDLL_ROOT%\load_asplib_MatlabDll.m %MATLAB_WORKSPACE%\load_asplib_MatlabDll.m
COPY /A %ASPLIB_MATLABDLL_ROOT%\unload_asplib_MatlabDll.m %MATLAB_WORKSPACE%\unload_asplib_MatlabDll.m
